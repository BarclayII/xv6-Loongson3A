...
\begin{document}
	...
	heap}. Just under that are values that allow a program to start at \texttt{\_\_start}, \hilite{where the control
	would soon transfer to \texttt{main()}}. To guard a stack growing off the
